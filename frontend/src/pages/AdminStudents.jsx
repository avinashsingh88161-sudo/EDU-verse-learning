              ...
              <table className="admin-data-table">
                ...
                <tbody>
                  {filteredStudents.map((student) => {
                    const count = student.enrolledCount ?? (student.enrolledCourses ? student.enrolledCourses.length : 0);
                    return (
                      <tr key={student._id}>
                        <td>
                        ...
                        <td>
                          <span className="badge badge-success">{student.avgQuizScore ?? 0}%</span>
                        </td>
                        <td>{student.submissionsCount ?? 0}</td>
